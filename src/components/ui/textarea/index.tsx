...
const textareaStyle = tva({
  ...
  variants: {
    variant: {
      default:
        'data-[focus=true]:border-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:data-[hover=true]:border-error-700 data-[invalid=true]:data-[focus=true]:data-[hover=true]:border-primary-700 data-[invalid=true]:data-[disabled=true]:data-[hover=true]:border-error-700',
    },
    size: {
      sm: '',
      md: '',
